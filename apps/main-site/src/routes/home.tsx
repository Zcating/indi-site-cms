...
export default function IndiHomeRoute() {
  ...
  if (!homeConfig) return <div>Loading config...</div>;
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <button
                ...
                className="consult-trigger rounded-full bg-mimoo-chocolate text-white px-8 py-4 font-bold text-lg hover:bg-mimoo-chocolate/80 transition-all shadow-lg hover:shadow-xl hover:-translate-y-1"
              >
                咨询代加工
              </button>
            </div>
