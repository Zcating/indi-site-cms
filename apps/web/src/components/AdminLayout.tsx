...
import { LayoutDashboard, Users, Image, FileText, LogOut, Menu } from 'lucide-react';
...
const navigation = [
  ...
  { name: '图片管理', href: '/admin/images', icon: Image },
        ...
        <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
            ...
            <div className="flex items-center gap-x-4 lg:gap-x-6">
              <span className="hidden text-sm font-medium text-gray-900 lg:block">{user?.name || user?.email}</span>
            </div>
          </div>
        </div>
